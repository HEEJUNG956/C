...
// MFC TimerThreadDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "MFC TimerThread.h"
#include "MFC TimerThreadDlg.h"
...
// CMFCTimerThreadDlg 대화 상자



CMFCTimerThreadDlg::CMFCTimerThreadDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFC_TIMERTHREAD_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMFCTimerThreadDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_STATIC_DISP, m_staticDisp);
}

BEGIN_MESSAGE_MAP(CMFCTimerThreadDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_TIMER()
...
// CMFCTimerThreadDlg 메시지 처리기

BOOL CMFCTimerThreadDlg::OnInitDialog()
{
...
void CMFCTimerThreadDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMFCTimerThreadDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMFCTimerThreadDlg::OnQueryDragIcon()
{
...
void CMFCTimerThreadDlg::OnTimer(UINT_PTR nIDEvent)
{
