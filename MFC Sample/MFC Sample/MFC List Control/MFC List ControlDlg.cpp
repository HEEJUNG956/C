...
// MFC List ControlDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "MFC List Control.h"
#include "MFC List ControlDlg.h"
...
BEGIN_MESSAGE_MAP(CMFCListControlDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(ButtonAdd, &CMFCListControlDlg::OnBnClickedButtonadd)
	ON_BN_CLICKED(ButtonDelete, &CMFCListControlDlg::OnBnClickedButtondelete)
END_MESSAGE_MAP()
...
void CMFCListControlDlg::OnBnClickedButtonadd()
{
...
void CMFCListControlDlg::OnBnClickedButtondelete()
{
	...
	{
		if (m_List.GetItemState(i, LVIS_SELECTED != 0)) // 선택한 항목을 삭제
		{
			m_List.DeleteItem(i);
		}
	}
