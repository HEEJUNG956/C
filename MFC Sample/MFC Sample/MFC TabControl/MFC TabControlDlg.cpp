...
CMFCTabControlDlg::CMFCTabControlDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFC_TABCONTROL_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CMFCTabControlDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(TCN_SELCHANGE, IDC_TAB_MAIN, &CMFCTabControlDlg::OnSelchangeTabMain)
END_MESSAGE_MAP()


// CMFCTabControlDlg 메시지 처리기
